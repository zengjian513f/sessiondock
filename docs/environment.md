...
| `SESSIONDOCK_BUG_REPORT_REPO` | `bug_report_repo` | no (Option) | The repository a bug-report worker investigates (Python `PROJECT_ROOT`): the worker's cwd and the parent of `agenthub_attachments/` | no | [bug-report.md](bug-report.md) |
