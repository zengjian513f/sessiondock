...
| `SESSIONDOCK_BUG_REPORT_DIR` | `bug_report_dir` | no (Option) | Bug-report bundles (Python `bug_report.REPORT_ROOT`): an configured bundle directory | no | [bug-report.md](bug-report.md), [capabilities.md](capabilities.md), [error-codes.md](error-codes.md) |
