...
| bug_report_real | `python3 tests/bug_report_real.py` | Real Claude worker with the required model and temporary config; verifies native confirmation and cleanup. | claude CLI, ptyhost | 25s |
