...
| bug_report_node_browser | `python3 tests/bug_report_node_browser.py` | Hub report dialog machine selection, disabled CLI choices and cross-machine capture/submit bodies against fake nodes; no CLI or real histories | hub binary, Chromium | n/a |
