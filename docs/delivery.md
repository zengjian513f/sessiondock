...
Submission and confirmation match the frozen Python queue, protocol, audit and
native bridge code.
...
uses Python's text and timing rules. Accepted text may lack a turn ID.
...
parent and child identity. Interruption follows Python composer behavior.
...
the frozen Python bridge. See [terminal-input.md](terminal-input.md) and
