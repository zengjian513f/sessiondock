...
MAP = {
    ...
    "--node-token-file": ("SESSIONDOCK_NODE_TOKEN_FILE", "node listener credential (with NODE_BIND/NODE_ID_FILE/NODE_PEERS)"),
    "--node-id-file": ("SESSIONDOCK_NODE_ID_FILE", "node identity file, minted O_EXCL 0600 on first start"),
